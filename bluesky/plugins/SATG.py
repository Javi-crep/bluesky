...
def SATG_HELP(topic: str = ""):
    ...
    lines = [
        ...
        "Supports conflict generation, historical traffic replay, procedural operations,",
        "and ML-based synthetic traffic generation using TraffixGen integration.",
        "",
        "Historic Sampling (ML-based Synthetic Traffic)",
        "==============================================",
        "Historic Sampling uses TraffixGen ML models to generate synthetic traffic",
        "from learned patterns in historical EUROCONTROL data. Access via GUI or:",
        "",
        "- Load EUROCONTROL data in GUI Historic Sampling tab", 
        "- Train ML models on filtered trajectory data",
        "- Generate synthetic scenarios with learned traffic patterns",
        "- Export scenarios for BlueSky simulation",
        "",
        "For command-line TraffixGen operations, use TRAFFIXGEN commands directly.",
        "",
        "Realistic Replay (Historical Data Replay)",
        "=========================================",
        "Generate scenarios from actual historical flight data with optional jitter:",
        "",
        "Data Loading:",
        "  SATG_RL_LOAD flights.csv points.csv",
        "  SATG_RL_LOAD_DATA flights_json points_json",
        "",
        "Configuration:",
        "  SATG_RL_JITTER mode [dt=secs] [dlat=deg] [dlon=deg] [dfl=ft] [dspd=kt]",
        "    - mode: on|off|config (enable/disable jitter or configure parameters)",
        "  SATG_RL_AUTODEL mode",
        "    - mode: on|off (auto-delete conflicting aircraft)",
        "  SATG_RL_PHASE_JITTER mode",
        "    - mode: on|off (enable phase-specific jitter)",
        "  SATG_RL_PHASE_CONFIG phase [enabled] [dt] [dlat] [dlon] [dfl]",
        "    - phase: departure|climb|cruise|descent|approach",
        "  SATG_RL_PHASE_ALTITUDES phase [min_fl] [max_fl]",
        "  SATG_RL_TRACK_CONFIG ectrl_id initial_climb top_of_climb top_of_descent final_approach",
        "",
        "Generation:",
        ...
        "Geometric Conflicts",
        "===================",
        "Generate precise conflict scenarios with mathematical conflict geometry:",
        "",
        "Configuration:",
        "  SATG_GC_CONF hsep_nm vsep_ft",
        "    - Set horizontal separation (nm) and vertical separation (feet)",
        "  SATG_GC_TYPES type1 type2 ...",
        "    - Set encounter types: headon,cross,overtake",
        "  SATG_GC_RANGE [cas1=kt] [cas2=kt] [fl1=level] [fl2=level] [brg1=deg] [angle=deg]", 
        "    - Set sampling ranges for aircraft parameters",
        "",
        "Generation:",
        ...
        "  SATG_GC_REL rel_brg rel_range rel_alt tcpa [seed] [overwrite]",
        "    - Generate relative conflicts for training aircraft",
        "",
        "Execution:",
        "  SATG_GC_RUN name",
        "  SATG_GC_DEL (delete all geometric conflict aircraft)",
        "",
        "Random Conflicts (in circles or custom polygons)",
        "================================================",
        "Generate randomized conflicts within defined areas:",
        "",
        "SATG_RC_CIRCLE name N types lat lon radius mode altmode tcpa fl cas actypes [options]",
        ...
        "",
        "Procedural Traffic (SID/STAR Operations)",
        "=======================================",
        "Generate traffic following standard instrument procedures:",
        "",
        "Setup Commands:",
        "  SATG_PROC_LOAD_WPT path_to_waypoints.scn",
        "  SATG_PROC_UNLOAD_WPT path_to_waypoints.scn",
        "  SATG_PROC_CLEAR_WPT",
        "",
        "  SATG_PROC_LOAD_PROC path_to_procedure.scn", 
        "  SATG_PROC_LOAD_CUSTOM (auto-load all files from procedures/ folder)",
        "  SATG_PROC_UNLOAD_PROC path_to_procedure.scn",
        "  SATG_PROC_CLEAR_PROC",
        "  SATG_PROC_EXPORT_POLY polygon_name",
        "  SATG_PROC_CREATE_FROM_POLY polygon_name [procedure_name]",
        "  SATG_PROC_LOAD_FOR_EDIT procedure_name",
        ...
        "",
        "Aircraft Types:",
        "  SATG_PROC_TYPES_GENERIC type1 type2 ...",
        "  SATG_PROC_TYPES_SID type1 type2 ...",
        "  SATG_PROC_TYPES_STAR type1 type2 ...",
        "  SATG_AVAILABLE_ACTYPES (list all available aircraft types)",
        "",
        "Override Settings:",
        "  SATG_PROC_OVERRIDE_GENERIC initial_alt initial_spd final_alt final_spd",
        "  SATG_PROC_OVERRIDE_SID initial_alt initial_spd",
        "  SATG_PROC_OVERRIDE_STAR initial_alt initial_spd final_alt final_spd",
        "",
        "Traffic Scheduling:",
        ...
        "  SATG_PROC_USE_DEST flag",
        "  SATG_PROC_SET_DEST proc_id airport1 airport2 ...",
        "",
        "Generation:",
        ...
        "====================",
        "Create and manage custom polygon areas for traffic generation:",
        "",
        "  SATG_POLY_CREATE name lat1 lon1 lat2 lon2 [lat3 lon3 ...]",
        "    - Create polygon with specified coordinates",
        "  SATG_POLY_LIST",
        "    - List all available polygons",
        "  SATG_POLY_INFO name",
        "    - Show polygon information and statistics", 
        ...
        "System Management",
        "=================",
        "  SATG_DIR [base_directory]",
        "    - Set or display base directory for scenario files",
        "",
        "General Notes",
        "=============",
        ...
        "- GUI provides visual interface for all major functions",
        "",
        "Use SATG_HELP [topic] for focused help on specific commands.",
        "Topics: realistic, geometric, random, procedural, polygon, historic",
    ]
